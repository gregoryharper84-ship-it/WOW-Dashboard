...
This skill is designed for moneylines, match winners, and selected supported player props. It must use live governance, legacy platform, connected APIs, official sources, specialist models, and deep web research before publishing a probability or edge.
