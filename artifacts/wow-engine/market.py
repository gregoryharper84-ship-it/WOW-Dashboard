...
def exact_match(a: MarketQuote, b: MarketQuote) -> bool:
    ...
    return same_identity and truly_opposing and is_fresh_pair(a, b)
...
def resolve_market_prior(
    ...
    if not exact_match(side_a, side_b):
