...
# Keep the synthetic event safely in the future and derive the requested slate
# date from that event in the same timezone used by the runtime. This avoids
# midnight/date-rollover failures while preserving the production pregame/date
# filtering behavior under test.
