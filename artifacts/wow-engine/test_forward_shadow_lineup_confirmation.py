...
def test_confirmation_requires_official_nine_player_orders_for_both_teams():
    sql = _sql()
    assert "https://statsapi.mlb.com/api/v1/game/%s/boxscore" in sql
    assert "home,battingorder" in sql
    assert "away,battingorder" in sql
