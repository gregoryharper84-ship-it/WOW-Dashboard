...
@pytest.mark.parametrize(
    ...
    [
        ...
        (oidc.NCAAF_ML_CLOSURE_WORKFLOW_REF, "/.github/workflows/wow-v17-ncaaf-ml-closure.yml@refs/heads/main"),
        ...
        (oidc.SPREAD_MARGIN_REPLAY_WORKFLOW_REF, "/.github/workflows/wow-v17-spread-margin-replay.yml@refs/heads/main"),
    ],
)
...
def test_workflow_allowlist_contains_only_known_internal_workflows():
    assert oidc.ALLOWED_WORKFLOW_REFS == frozenset({
        ...
        oidc.NCAAF_ML_CLOSURE_WORKFLOW_REF,
