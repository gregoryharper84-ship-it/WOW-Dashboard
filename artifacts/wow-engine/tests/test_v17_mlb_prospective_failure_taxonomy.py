...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("calibration_health_not_pass", MODEL_UNAVAILABLE, 409),
        ...
        ("wow_mlb_v2d_intercept_calibration:required_row_missing", MODEL_UNAVAILABLE, 409),
    ],
)
...
def test_team_event_bridge_preserves_output_and_scorer_taxonomy(monkeypatch):
    monkeypatch.setattr(
        bridge,
        "team_event_capability",
        lambda sport: SimpleNamespace(
