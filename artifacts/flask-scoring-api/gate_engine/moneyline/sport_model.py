...
def compute_independent_probability(
    ...
    home_probability = round(ensemble_prob, 4)
    away_probability = round(1.0 - ensemble_prob, 4)
    return {
        # Backwards-compatible home-team value.  The canonical pair below is
        # the contract consumed by the pipeline for binary moneyline rows.
        "independent_probability":   home_probability,
