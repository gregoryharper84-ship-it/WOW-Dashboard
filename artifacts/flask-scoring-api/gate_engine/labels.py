...
class PropLabel(str, Enum):
    ...
    # WOW-PATCH-2026-07-30 — WNBA Composite + MLB Directional + Cross-Ticket
    MLB_K_LESS_WATCH                        = "MLB_K_LESS_WATCH"
    MLB_OUTS_MORE_HOLD                      = "MLB_OUTS_MORE_HOLD"
    WNBA_COMPOSITE_WATCH                    = "WNBA_COMPOSITE_WATCH"
    WNBA_COMPOSITE_SCOUT                    = "WNBA_COMPOSITE_SCOUT"
    WNBA_COMPOSITE_MODEL_READY              = "WNBA_COMPOSITE_MODEL_READY"
    WNBA_SLATE_PURGE                        = "WNBA_SLATE_PURGE"
    NO_DUPLICATE_EXPOSURE                   = "NO_DUPLICATE_EXPOSURE"
    REJECT_EXACT_DUPLICATE                  = "REJECT_EXACT_DUPLICATE"
    REJECT_ALTERNATE_THRESHOLD_DUPLICATE    = "REJECT_ALTERNATE_THRESHOLD_DUPLICATE"
    REJECT_DUPLICATE_STRUCTURE              = "REJECT_DUPLICATE_STRUCTURE"
    REJECT_DUPLICATE_PITCHER_THESIS         = "REJECT_DUPLICATE_PITCHER_THESIS"
    # WOW-PATCH-2026-08-02-LLP-MATCHUP-EV-INTEGRITY
    # Source reconciliation doctrine labels (2026-08-03)
    LINE_ACTIVE_UNCONFIRMED              = "LINE_ACTIVE_UNCONFIRMED"
    RECONCILIATION_REQUIRED              = "RECONCILIATION_REQUIRED"
    EXACT_LINE_AUDIT_REQUIRED            = "EXACT_LINE_AUDIT_REQUIRED"
    WEATHER_SOURCE_INVALID_FOR_SETTLEMENT = "WEATHER_SOURCE_INVALID_FOR_SETTLEMENT"
    ESPN_BLURB_STALE_AVERAGES            = "ESPN_BLURB_STALE_AVERAGES"
    PIPELINE_INTEGRITY_FAILURE           = "PIPELINE_INTEGRITY_FAILURE"
    VARIANCE_INCREASE                    = "VARIANCE_INCREASE"
    # WOW-PATCH-2026-08-02-LLP-SLIP-CONSTRUCTION-INTEGRITY
    CROSS_BOOK_PARLAY_ILLUSION           = "CROSS_BOOK_PARLAY_ILLUSION"
    SAME_GAME_CORRELATED_STACK           = "SAME_GAME_CORRELATED_STACK"
    SELECTIVE_RECENCY_APPLIED            = "SELECTIVE_RECENCY_APPLIED"
    # WOW-PATCH-2026-08-01-MULTI-WINDOW-PROP-PERSISTENCE-AND-DISTRIBUTION-AUDIT
    # Persistence & window classification
    RECENT_FORM_DIVERGENCE               = "RECENT_FORM_DIVERGENCE"
    OUTLIER_OR_ROLE_AUDIT_REQUIRED       = "OUTLIER_OR_ROLE_AUDIT_REQUIRED"
    # Same-player clustering
    SAME_PLAYER_SHARED_THESIS            = "SAME_PLAYER_SHARED_THESIS"
    # Slate separation
    NEXT_DAY_PREVIEW                     = "NEXT_DAY_PREVIEW"
    # Prohibited reasoning patterns (GPT enforcement + backend blocker codes)
    LAW_OF_AVERAGES_SUPPORT              = "LAW_OF_AVERAGES_SUPPORT"
    HOT_STREAK_AS_PROBABILITY            = "HOT_STREAK_AS_PROBABILITY"
    ONE_GAME_SAMPLE_INSUFFICIENT         = "ONE_GAME_SAMPLE_INSUFFICIENT"
    # WOW-PATCH-2026-08-15 — PP Promotion Gate & Same-Game Fragility
    REJECT_PP_PROMOTION_GATE             = "REJECT_PP_PROMOTION_GATE"
    REJECT_SAME_EVENT_NO_JOINT_MODEL     = "REJECT_SAME_EVENT_NO_JOINT_MODEL"
    REJECT_RECENCY_SHOCK                 = "REJECT_RECENCY_SHOCK"
    FATAL_REJECTED_LEG_IN_CARD           = "FATAL_REJECTED_LEG_IN_CARD"
    PREGAME_SNAPSHOT_BLOCK               = "PREGAME_SNAPSHOT_BLOCK"
    FINAL_REFRESH_REQUIRED               = "FINAL_REFRESH_REQUIRED"
...
REJECT_LABELS   = {
    ...
    # WOW-PATCH-2026-07-30 — Cross-Ticket + Directional
    PropLabel.REJECT_EXACT_DUPLICATE,
    PropLabel.REJECT_ALTERNATE_THRESHOLD_DUPLICATE,
    PropLabel.REJECT_DUPLICATE_STRUCTURE,
    PropLabel.REJECT_DUPLICATE_PITCHER_THESIS,
    PropLabel.WNBA_SLATE_PURGE,
    # WOW-PATCH-2026-08-15 — PP Promotion Gate & Same-Game Fragility
